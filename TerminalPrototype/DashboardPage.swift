...
struct DashboardPage: View {
    ...
    private func formatMetricTitle(_ metric: String) -> String {
        let readableTitles: [String: String] = [
            ...
            "cashFlowFromOperating": "Cash Flow from Operating Activities",
            "cashFlowFromInvesting": "Cash Flow from Investing Activities",
            "cashFlowFromFinancing": "Cash Flow from Financing Activities",
            "ebit": "EBIT",
            "ebitda": "EBITDA"
        ]
        
        return readableTitles[metric] ?? metric
